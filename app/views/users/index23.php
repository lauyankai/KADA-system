                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= htmlspecialchars($pendingregistermember['name']); ?></td>
                                <td><?= htmlspecialchars($pendingregistermember['ic_no']); ?></td>
                                <td class="text-center action-buttons">
                                    <a href="/edit/<?= $pendingregistermember['id']; ?>" class="btn btn-warning btn-sm">
